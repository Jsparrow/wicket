...
public class RadioGroupPage extends WicketExamplePage
{
	...
	{
		String html = new StringBuilder().append("<form wicket:id=\"form\">\n").append("<span wicket:id=\"group\">\n").append("<tr wicket:id=\"persons\">\n").append("<td><input type=\"radio\" wicket:id=\"radio\"/></td>\n").append("<td><span wicket:id=\"name\">[this is where name will be]</span></td>\n").append("<td><span wicket:id=\"lastName\">[this is where lastname will be]</span></td>\n").append("</tr>\n").append("</span>")
				.append("</form>").toString();
		String code = new StringBuilder().append("&nbsp;&nbsp;&nbsp;&nbsp;Form f=new Form(\"form\");<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;add(f);<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;RadioGroup group=new RadioGroup(\"group\");<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;form.add(group);<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;ListView persons=new ListView(\"persons\", getPersons()) {<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;protected void populateItem(ListItem item) {<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.add(new Radio(\"radio\", item.getModel()));<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.add(new Label(\"name\", new PropertyModel(item.getModel(), \"name\")));<br/>")
				.append("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;item.add(new Label(\"lastName\", new PropertyModel(item.getModel(), \"lastName\")));<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;};<br/>").append("&nbsp;&nbsp;&nbsp;&nbsp;group.add(persons);<br/>").toString();
