...
class XmlPartialPageUpdateTest extends WicketTestCase
{
	...
	void encodeCdataEnd()
	{
		...
		String expected = new StringBuilder().append("<?xml version=\"1.0\" encoding=\"UTF-8\"?><ajax-response><component id=\"container1\" ><![CDATA[<span wicket:id=\"container\" id=\"container1\"> two brackets: ]] greater than: > CDATA end: ]]]]><![CDATA[> </span>]]></component><header-contribution><![CDATA[<head xmlns:wicket=\"http://wicket.apache.org\"><script type=\"text/javascript\">\n").append("/*<![CDATA[*/\n").append("// two brackets: ]] greater than: > CDATA end: ]]]]><![CDATA[>\n").append("/*]]]]><![CDATA[>*/\n").append("</script>\n").append("</head>]]></header-contribution></ajax-response>").toString();
