 ...
 * 
 */
public class InitializerStringResourceLoaderTest extends StringResourceLoaderTestBase
{
	...
	{
		assertNull(loader.loadStringResource((Class<?>)null, "fhadfjksd", null, null, null));
	}
}
