...
public class ComponentRenderer
{
	...
	private void initApplication()
	{
		...
		application.setName(new StringBuilder().append("ComponentRenderer[").append(System.identityHashCode(ComponentRenderer.this)).append("]").toString());
	...
	public static CharSequence renderComponent(final Component component)
	{
		...
		{
			LOGGER.warn(new StringBuilder().append("Component '{}' with a parent '{}' is passed for standalone rendering. ").append("It is recommended to render only orphan components because they are not cleaned up/detached").append(" after the rendering.").toString(), component, oldParent);
		}
			...
			IMarkupCacheKeyProvider
	{
		...
		private final Logger logger = LoggerFactory.getLogger(RenderPage.class);
		...
		private RenderPage(Component component)
		{
			...
			{
				logger.error(mnfx.getMessage(), mnfx);
